      ...
      <div className="flex flex-col lg:flex-row min-h-screen">
        ...
        <div className="lg:w-[56vw] flex flex-col justify-center px-6 sm:px-10 lg:px-[6vw] py-16 lg:py-0">
          ...
          <p className="text-lg text-[#A9B3C2] max-w-xl mb-10 scroll-animate opacity-0 delay-200">
            Engage us as your outsourced legal department or project counsel. We offer 
            flexible models and rapid response protocols to accelerate your strategic objectives.
          </p>
          ...
          {/* CTA */}
          <div className="scroll-animate opacity-0" style={{ transitionDelay: '500ms' }}>
            <button
